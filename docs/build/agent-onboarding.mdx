...
This returns all 32 entities across 11 product domains -- CRM, Billing, Projects, Content, Support, Analytics, Marketing, Experiments, and Platform -- with their verbs, relationships, and field definitions. No documentation lookup required. The system describes itself.
...
**Agent explores** -- discovers 32 entities and their verbs.
