...
Restart Claude Desktop. The agent connects at L0 (anonymous, read-only) and can immediately explore all 35 entities. Ask Claude to "explore headless.ly" and it will discover the full entity graph -- CRM, Billing, Projects, Content, Support, Analytics, Marketing, Experiments, Platform.
