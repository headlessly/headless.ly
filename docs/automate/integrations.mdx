...
Stripe is the truth source for all Billing entities. See the [Stripe reference](/reference/integrations/stripe) for entity mapping and webhook events.
...
GitHub is the truth source for all Projects entities. See the [GitHub reference](/reference/integrations/github) for entity mapping and webhook events.
