...
Identity is backed by WorkOS through [id.org.ai](https://id.org.ai). The legacy [oauth.do](https://oauth.do) domain remains available as a compatibility wrapper. Users authenticate, ApiKeys enable programmatic access. Organization is defined in the [CRM](/entities/crm) domain.
