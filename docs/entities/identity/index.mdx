...
Identity is backed by WorkOS through [id.org.ai](https://id.org.ai). The legacy [oauth.do](https://oauth.do) surface remains supported as a compatibility wrapper. Users authenticate through SSO, magic links, or social login. ApiKeys enable machine-to-machine access with scoped permissions.
