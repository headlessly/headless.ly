...
The `$` argument provides access to all 32 entities across all domains. Import it from `@headlessly/sdk` when used outside a hook:
...
All custom verbs across the 32 core entities:
