...
Alerts are generated automatically when metrics cross configured thresholds. Configure thresholds via [Metric watches](/docs/reference/sdk/events#metric-watches).
