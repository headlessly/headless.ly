...
await Content.create({
  ...
  props: {
    ...
    features: [
      ...
      { title: '32 entities', description: 'CRM, billing, projects, and more' },
    ],
    testimonials: [
...
- [Content Reference](/docs/reference/entities/content) -- full Content entity definition with all types
