...
- [Launch Campaigns](/docs/launch/campaigns) -- target campaigns at your segments
- [Lead Capture Forms](/docs/launch/forms) -- link forms to segments for attribution
- [Marketing Reference](/docs/reference/entities/marketing) -- full Segment entity definition with ICP fields
