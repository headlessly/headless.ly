...
- [Landing Pages](/docs/launch/pages) -- embed forms on your launch pages
- [Launch Campaigns](/docs/launch/campaigns) -- attribute form submissions to campaigns
- [Audience Segments](/docs/launch/segments) -- group form respondents into targetable segments
- [CRM Reference](/docs/reference/entities/crm) -- full Contact entity definition
- [Marketing Reference](/docs/reference/entities/marketing) -- full Form entity definition
